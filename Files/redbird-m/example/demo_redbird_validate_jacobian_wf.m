...
cfg.srcparam2=[0 80 0 0];
cfg.srcpattern = srcpattern;
cfg.srcdir=[0 0 1];

cfg.dettype='pattern';
cfg.detpos=[60 20 60];
cfg.detparam1=[80 0 0 0];
cfg.detparam2=[0 80 0 0];
cfg.detpattern = detpattern;
cfg.detdir=[0 0 -1];
...
perturbeid=find(abs(c0(:,1)-xi(sid))<srad & abs(c0(:,2)-xi(sid))<srad & abs(c0(:,3)-zdepth)<srad);
